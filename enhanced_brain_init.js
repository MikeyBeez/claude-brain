// Enhanced brain_init handler with capability framework awareness
// This is the new handler code to be integrated into index.js

const enhancedBrainInitHandler = async ({ reload = false }) => {
  try {
