...
class ContextDiscoveryService {
  ...
  async discoverContext(userMessage, options = {}) {
    console.log('🔍 Starting context discovery for user intent...');
  ...
  async getActiveProjectContext() {
    try {
      ...
      console.log('No active project context found, using default');
    }
