...
class ProtocolRegistry {
  constructor(options = {}) {
    ...
    console.log('📚 ProtocolRegistry initialized with metadata management');
  ...
  initializeBuiltInProtocols() {
    ...
    console.log(`📚 Registered ${builtInProtocols.length} built-in protocols`);
  }
  ...
  registerProtocol(protocolData) {
    try {
      ...
      console.log(`📝 Registered protocol: ${protocol.id} (${protocol.category})`);
      return true;
  ...
  recordProtocolUsage(protocolId, usageData) {
    ...
    console.log(`📊 Recorded usage for protocol: ${protocolId}`);
  }
  ...
  cleanupCache() {
    ...
    console.log(`🧹 Cleaned up ${this.queryCache.size} cached queries`);
  }
  ...
  importRegistryData(data) {
    ...
    console.log(`📥 Imported registry data: ${this.protocols.size} protocols`);
  }
  ...
  rebuildIndexes() {
    ...
    console.log('🔄 Rebuilt protocol indexes');
  }
}
